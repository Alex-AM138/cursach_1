...
def excel_reader(filepath: str = "") -> Any:
    """
    Функция принимает путь к '.xlsx-файлу' и возвращает список словарей.
    """
    try:
...
def get_currency_rates(currency_list: list) -> Any:
    """
    Функция через внешний API возвращает курсы валют.
    """
